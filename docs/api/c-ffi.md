...
Auto-generated from [`include/ctap2.h`](https://github.com/Jesssullivan/zig-ctap2/blob/main/include/ctap2.h).

All functions are blocking (with timeouts) and thread-safe. Result data is written to caller-provided buffers.
```c
#define CTAP2_OK                    0
```
